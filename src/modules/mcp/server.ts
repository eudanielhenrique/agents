    ...
    registerTenantTool(
      ...
      "agent_settings_set",
      {
        ...
        inputSchema: {
          ...
          whazingIntake: z.record(z.string(), z.unknown()).optional(),
          dry_run: z.boolean().optional(),
        },
      },
      async (
